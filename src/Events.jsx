...
export const Events = () => {
  return (
    <>
      <section className="features" style={{ backgroundColor: "#FEF8F5" }}>
        <div className="container">
          ...
          <div className="row" data-aos="fade-up">
            <div className="col-md-5">
              <img src="features/features-1.svg" className="img-fluid" alt="" />
            </div>
          ...
          <div className="row" data-aos="fade-up">
            <div className="col-md-5 order-1 order-md-2">
              <img src="features/features-2.svg" className="img-fluid" alt="" />
            </div>
          ...
          <div className="row" data-aos="fade-up">
            <div className="col-md-5">
              <img src="features/features-3.svg" className="img-fluid" alt="" />
            </div>
          ...
          <div className="row" data-aos="fade-up">
            <div className="col-md-5 order-1 order-md-2">
              <img src="features/features-4.svg" className="img-fluid" alt="" />
            </div>
            <div className="col-md-7 pt-5 order-2 order-md-1">
              <h3>
